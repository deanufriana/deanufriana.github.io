...
export const ui = {
  en: {
    ...
    'services.1.desc': 'I build robust, scalable, and fast web applications specifically tailored to your business needs.',
    'services.2.title': 'Website Modernization',
    'services.2.desc': 'Turn your legacy codebase into a modern, easy-to-maintain React or Vue architecture.',
    'services.3.title': 'Performance Optimization',
    'services.3.desc': 'Audit and optimize your existing web apps for blazing fast load times and better core web vitals.',
    ...
    'projects.subtitle': "Clients' private projects are confidential and never shared. I only showcase open-source work here to protect your intellectual property—your project remains 100% yours.",
    ...
    'cta.desc': 'Book a free 30-minute consultation to discuss your project requirements, timeline, and architectural approach—no strings attached.',
  ...
  id: {
    ...
    'services.1.desc': 'Saya membangun aplikasi web yang handal, skalabel, dan cepat sesuai dengan kebutuhan bisnis Anda.',
    'services.2.title': 'Modernisasi Website',
    'services.2.desc': 'Ubah sistem lawas Anda menjadi arsitektur React atau Vue yang modern dan mudah dipelihara.',
    'services.3.title': 'Optimasi Performa',
    'services.3.desc': 'Audit dan optimasi aplikasi web Anda agar memuat lebih cepat dan meningkatkan metrik web vital.',
    ...
    'projects.subtitle': 'Proyek pribadi klien bersifat rahasia dan tidak ditampilkan di sini. Saya hanya menampilkan karya open-source untuk melindungi kekayaan intelektual Anda—proyek Anda tetap milik Anda sepenuhnya.',
    'projects.openSource': 'Proyek Open Source',
    'projects.personal': 'Proyek Pribadi',
    'cta.heading1': 'Siap memulai proyek',
    'cta.heading2': 'Anda?',
    'cta.desc': 'Jadwalkan konsultasi gratis 30 menit untuk mendiskusikan kebutuhan proyek, tenggat waktu, dan pendekatan teknis—tanpa ikatan.',
