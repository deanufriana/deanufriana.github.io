...
export const ui = {
  en: {
    ...
    "about.principles.label": "Coding Principles",
    "about.principles.1.title": "Readable by Default",
    "about.principles.1.desc": "Code is written for humans first, machines second.",
    "about.principles.2.title": "Maintainability",
    "about.principles.2.desc": "Structured so any developer can pick it up instantly.",
    "about.principles.3.title": "Performance First",
    "about.principles.3.desc": "Optimized for speed, efficiency, and core web vitals.",
    ...
    "services.4.title": "Clean & Maintainable Code",
    "services.4.desc":
      "I don't just complete tasks. I deliver readable, high-performance code built for maintainability, ensuring you or another developer can easily continue the project without me.",
    ...
    "cta.desc":
      "Book a free 30-minute consultation to discuss your project. Every delivery includes clean code, performance optimization, and a full handover—so your project is built to last.",
  ...
  id: {
    ...
    "about.principles.label": "Prinsip Koding",
    "about.principles.1.title": "Mudah Dibaca",
    "about.principles.1.desc": "Kode ditulis untuk manusia dulu, baru mesin.",
    "about.principles.2.title": "Mudah Dipelihara",
    "about.principles.2.desc": "Terstruktur agar pengembang lain bisa melanjutkannya.",
    "about.principles.3.title": "Performa Utama",
    "about.principles.3.desc": "Dioptimalkan untuk kecepatan dan efisiensi.",
    "about.techStack": "Tech Stack",
    ...
    "services.4.title": "Kode Bersih & Mudah Dipelihara",
    "services.4.desc":
      "Saya tidak hanya sekadar menyelesaikan tugas. Saya menulis kode yang mudah dibaca, berperforma tinggi, dan mudah dipelihara, sehingga Anda atau pengembang lain dapat melanjutkannya tanpa kendala.",
    ...
    "cta.heading2": "Anda?",
    "cta.desc":
      "Jadwalkan konsultasi gratis 30 menit. Setiap proyek menyertakan kode bersih, optimasi performa, dan dokumentasi lengkap agar proyek Anda siap untuk jangka panjang.",
